...
Добавлена команда `search-trains` для поездов Tutu.ru. Она принимает русские
названия или семизначные коды направлений, дату, сортировку и лимит. API отдаёт
кэшированное расписание и ориентировочные цены без проверки выбранной даты,
поэтому наличие поезда, мест и итоговую цену нужно подтвердить по ссылке.
